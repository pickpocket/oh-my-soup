...
/** Tool-search server-tool call whose matching result is replayable by oms. */
...
/** Anthropic server-tool history variants oms can replay atomically. */
...
/** True when a block is complete Anthropic server-tool history oms can replay. */
