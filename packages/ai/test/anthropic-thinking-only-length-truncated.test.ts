...
import type { AssistantMessage, Message, Model, UserMessage } from "@oh-my-soup/pi-ai/types";
 ...
 *
 * Reproduces the shape captured in `~/.oms/logs/http-400-requests/*.json` after Claude
