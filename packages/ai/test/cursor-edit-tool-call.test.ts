...
import { kCursorExecResolved, kStreamingBlockKind } from "@oh-my-soup/pi-ai/utils/block-symbols";
...
const TARGET = "/tmp/oms-cursor-edit-probe/note.txt";
		...
		const execHandlers: CursorExecHandlers = {
			async read(args) {
				...
				return {
					...
					toolName: "read",
					content: [{ type: "text", text: "Hello from OMS probe.\nThe fruit is apple.\nGoodbye.\n" }],
					isError: false,
					timestamp: 1,
