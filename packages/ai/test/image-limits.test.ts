...
import { complete } from "@oh-my-soup/pi-ai/stream";
import type { Api, Context, ImageContent, Model, OptionsForApi, UserMessage } from "@oh-my-soup/pi-ai/types";
import { getBundledModel } from "@oh-my-soup/pi-catalog/models";
import { $which, removeSyncWithRetries } from "@oh-my-soup/pi-utils";
import { e2eApiKey } from "./oauth";

const TEMP_DIR = fs.mkdtempSync(path.join(os.tmpdir(), "oms-temp-images-"));
