...
import { convertResponsesInputContent } from "@oh-my-soup/pi-ai/providers/openai-shared";
import type { Context, FetchImpl, Message, Model, ProviderFileReference, UserMessage } from "@oh-my-soup/pi-ai/types";
