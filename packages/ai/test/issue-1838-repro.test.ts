 ...
 * `reasoning_content` even though oms already sends it on the wire (the Kimi
...
import type { AssistantMessage, Context, FetchImpl, Model, ModelSpec } from "@oh-my-soup/pi-ai/types";
