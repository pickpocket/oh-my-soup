/**
 * Test helper for resolving API keys from ~/.oms/agent/testauth.db
 *
...
import { getOAuthApiKey } from "@oh-my-soup/pi-ai/oauth";
import type { OAuthCredentials, OAuthProvider } from "@oh-my-soup/pi-ai/oauth/types";
import { $flag, getAgentDir, isEnoent } from "@oh-my-soup/pi-utils";
...
/**
 * Resolve API key for a provider from ~/.oms/agent/testauth.db
 *
