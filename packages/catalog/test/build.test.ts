...
import { fingerprintStaticModels, resolveProviderModels } from "@oh-my-soup/pi-catalog/model-manager";
import { getBundledModel } from "@oh-my-soup/pi-catalog/models";
import { openrouterModelManagerOptions } from "@oh-my-soup/pi-catalog/provider-models/openai-compat";
import type { Api, Model, ModelSpec } from "@oh-my-soup/pi-catalog/types";
