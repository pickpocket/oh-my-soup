...
import { MODELS_DEV_PROVIDER_DESCRIPTORS } from "@oh-my-soup/pi-catalog/provider-models/openai-compat";
import type { OpenAICompat } from "@oh-my-soup/pi-catalog/types";
