 ...
 */
import { createAgentSession, discoverSkills, SessionManager, type Skill } from "@oh-my-soup/pi-coding-agent";

// Discover all skills from cwd/.oms/skills, ~/.oms/agent/skills, etc.
