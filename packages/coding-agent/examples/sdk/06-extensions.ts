 ...
 * - ~/.oms/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.oms/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.oms/agent/extensions/ or .oms/extensions/
