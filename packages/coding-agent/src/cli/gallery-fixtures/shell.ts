	...
	eval: {
		...
		result: {
			content: [
				{
					type: "text",
					text: ["@oh-my-soup/coding-agent v0.42.0", "37 dependencies"].join("\n"),
				},
			],
			details: {
				language: "python",
				languages: ["python"],
				jsonOutputs: [["@ai-sdk/anthropic", "@oh-my-soup/pi-ai", "@oh-my-soup/pi-tui"]],
				cells: [
					{
						index: 0,
						title: "load config",
						...
						output: ["@oh-my-soup/coding-agent v0.42.0", "37 dependencies"].join("\n"),
						status: "complete",
						durationMs: 64,
						exitCode: 0,
					},
