...
import type { Api, ApiKey, AssistantMessage, AuthStorage, Model } from "@oh-my-soup/pi-ai";
...
/** Oms's model/provider adapter for llm-git's parser-aware one-shot algorithm. */
export class OmsCommitInference implements CommitInference {
