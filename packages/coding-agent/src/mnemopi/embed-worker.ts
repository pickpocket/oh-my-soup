 ...
 * `__oms_worker_mnemopi_embed` selector). The whole point of this module is
...
import { defaultLocalModelInitializer, type StandardEmbeddingModel } from "@oh-my-soup/pi-mnemopi/core";
