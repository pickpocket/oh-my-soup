...
/**
 * Holds mutable HUD and editor-adjacent chrome outside the transcript
 * container. The current TUI commits history from the transcript's explicit
 * frame plan, so these live siblings are never candidates for transcript
 * retirement.
 */
