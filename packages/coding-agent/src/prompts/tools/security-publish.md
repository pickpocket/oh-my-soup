Publish current OMS-native security scan's canonical result.
...
Tool: validates, fingerprints, assigns OMS-owned IDs, writes canonical security store, creates SARIF.
