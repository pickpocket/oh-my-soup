 ...
 * progress cadence so per-spawn forwarding never lags the source.
 */
...
/**
 * Leading-and-trailing rate limiter for forwarding progress whose flush cost
 * rebuilds details for every spawn in the task call.
 */
