...
import { Agent, type AgentMessage, type CompactionSummaryMessage } from "@oh-my-soup/pi-agent-core";
...
import { buildOpenAiNativeHistory } from "@oh-my-soup/pi-agent-core/compaction/openai";
import type { AssistantMessage, Model, OpenAIResponsesHistoryPayload } from "@oh-my-soup/pi-ai";
