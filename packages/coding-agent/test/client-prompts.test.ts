...
import { getPrompt, listPrompts, serverSupportsPrompts } from "@oh-my-soup/pi-coding-agent/mcp/client";
import type { MCPGetPromptResult, MCPPrompt, MCPPromptsListResult } from "@oh-my-soup/pi-coding-agent/mcp/types";
