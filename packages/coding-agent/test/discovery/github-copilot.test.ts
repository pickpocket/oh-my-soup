...
import { loadCapability, setDisabledProviders } from "@oh-my-soup/pi-coding-agent/capability";
import type { ContextFile } from "@oh-my-soup/pi-coding-agent/capability/context-file";
import { clearCache } from "@oh-my-soup/pi-coding-agent/capability/fs";
import type { Instruction } from "@oh-my-soup/pi-coding-agent/capability/instruction";
import type { Prompt } from "@oh-my-soup/pi-coding-agent/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@oh-my-soup/pi-coding-agent/capability/rule";
...
import "@oh-my-soup/pi-coding-agent/capability/context-file";
import "@oh-my-soup/pi-coding-agent/capability/instruction";
import "@oh-my-soup/pi-coding-agent/capability/prompt";
import "@oh-my-soup/pi-coding-agent/capability/rule";
import "@oh-my-soup/pi-coding-agent/discovery/github";
