...
import { renderMentalModelsBlock } from "@oh-my-soup/pi-coding-agent/hindsight/mental-models";
...
import { SessionMemory, type SessionMemoryHost } from "@oh-my-soup/pi-coding-agent/session/session-memory";
