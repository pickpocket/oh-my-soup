...
} from "@oh-my-soup/pi-coding-agent/internal-urls/history-protocol";
import {
...
import { CURRENT_SESSION_VERSION, type SessionEntry } from "@oh-my-soup/pi-coding-agent/session/session-entries";
