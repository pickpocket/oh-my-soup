...
const span = trace.getTracer("@oh-my-soup/pi-agent-core").startSpan("non-otlp-probe");
span.end();
logger.error("non-OTLP probe");
metrics.getMeter("@oh-my-soup/pi-coding-agent").createCounter("non_otlp_probe").add(1);
