...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@oh-my-soup/pi-coding-agent/session/messages";
import type { CustomMessageEntry } from "@oh-my-soup/pi-coding-agent/session/session-entries";
