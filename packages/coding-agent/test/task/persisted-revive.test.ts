...
import type { PreparedExtension } from "@oh-my-soup/pi-coding-agent/extensibility/extensions/types";
...
import { buildWakeRelayBody } from "@oh-my-soup/pi-coding-agent/task/executor";
