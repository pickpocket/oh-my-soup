...
import { handleArxiv } from "@oh-my-soup/pi-coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@oh-my-soup/pi-coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@oh-my-soup/pi-coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@oh-my-soup/pi-coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@oh-my-soup/pi-coding-agent/web/scrapers/types";
