...
import { handleDevTo } from "@oh-my-soup/pi-coding-agent/web/scrapers/devto";
import { handleGitLab } from "@oh-my-soup/pi-coding-agent/web/scrapers/gitlab";
import { handleHackerNews } from "@oh-my-soup/pi-coding-agent/web/scrapers/hackernews";
import { handleLobsters } from "@oh-my-soup/pi-coding-agent/web/scrapers/lobsters";
