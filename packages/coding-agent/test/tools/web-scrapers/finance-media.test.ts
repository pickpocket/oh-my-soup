...
import { handleArtifactHub } from "@oh-my-soup/pi-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@oh-my-soup/pi-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@oh-my-soup/pi-coding-agent/web/scrapers/discogs";
