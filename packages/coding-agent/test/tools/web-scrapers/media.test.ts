...
import { handleHuggingFace } from "@oh-my-soup/pi-coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@oh-my-soup/pi-coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@oh-my-soup/pi-coding-agent/web/scrapers/vimeo";
