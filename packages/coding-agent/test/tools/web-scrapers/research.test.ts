...
import { handleBiorxiv } from "@oh-my-soup/pi-coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@oh-my-soup/pi-coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@oh-my-soup/pi-coding-agent/web/scrapers/wikidata";
