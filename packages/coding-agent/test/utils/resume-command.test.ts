...
import { resumeCommand } from "@oh-my-soup/pi-coding-agent/utils/resume-command";
import { APP_NAME, getActiveProfile, setProfile } from "@oh-my-soup/pi-utils/dirs";
...
describe("resumeCommand", () => {
	...
	it("carries the active profile so the emitted hint is runnable verbatim", () => {
		// Profile sessions live in ~/.oms/profiles/<name>/agent, so a resume hint
