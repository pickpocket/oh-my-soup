 ...
 * of the fixture JSONL — exactly the frames a real `oms /collab` host emits.
 */

import type { AgentSnapshot, HostFrame, SessionEntry, SessionState, WireFrame } from "@oh-my-soup/pi-wire";
