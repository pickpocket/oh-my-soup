 ...
 * link/envelope half of `@oh-my-soup/pi-coding-agent/src/collab/protocol.ts`;
...
import type { ParsedCollabLink } from "@oh-my-soup/pi-wire";
import {
	DEFAULT_RELAY_URL,
...
export { COLLAB_PROTO } from "@oh-my-soup/pi-wire";
