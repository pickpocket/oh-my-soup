# @oh-my-soup/pi-mnemopi

Local SQLite memory engine for Oh My Soup agents.
...
```ts
import { Mnemopi } from "@oh-my-soup/pi-mnemopi";
...
The Oh My Soup coding-agent wrapper adds `mnemopi.scoping` on top of those constructor options:
