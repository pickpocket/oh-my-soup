...
```sh
bun add @oh-my-soup/snapcompact
```
...
```ts
import { renderMany, frames, resolveShape } from "@oh-my-soup/snapcompact";
...
```ts
import { compact } from "@oh-my-soup/snapcompact";
