...
export const SEARCH_PROVIDER_OPTIONS = [
	...
	},
	{
		value: "gemini",
		label: "Gemini",
		description: "Search grounding via Gemini (uses google-gemini-cli or google-antigravity OAuth)",
	},
	{
		value: "anthropic",
		label: "Anthropic",
	...
	},
	{
		value: "yandex",
		label: "Yandex",
		description: "Credential-free browser-backed scrape of Yandex's independent index",
	},
	{
		value: "mojeek",
		label: "Mojeek",
