...
/** Whether `error` is lock-acquisition contention from {@link withFileLock}/{@link withFileLockSync}. */
export function isFileLockContentionError(error: unknown): boolean {
