...
class Settings(BaseSettings):
    ...
    # Release sentinel
    release_sentinel_enabled: bool = Field(False, alias="ROBOMS_RELEASE_SENTINEL_ENABLED")
    release_commit_prefix: str = Field("chore: bump version to ", alias="ROBOMS_RELEASE_COMMIT_PREFIX")
    release_max_rounds: int = Field(5, alias="ROBOMS_RELEASE_MAX_ROUNDS")
    release_task_timeout_seconds: float = Field(3600.0, alias="ROBOMS_RELEASE_TASK_TIMEOUT_SECONDS")
    release_model: str | None = Field(None, alias="ROBOMS_RELEASE_MODEL")
