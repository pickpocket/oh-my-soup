...
from roboms.git_ops import rev_parse_head
...
from roboms.worker import DirectiveInfo, ReleaseTaskContext, TaskInputs, ThreadMessage, run_task
...
async def handle_release_ci(
    *,
    ...
    if row is None:
        session_dir = sandbox.workspace_root(repo_full, "release") / f".oms-session-{tag}"
