...
from roboms.host_tools import AbortController, ReleaseToolContext, ToolBindings, _git_identity_env
...
def _build_extra_env(settings: Settings) -> dict[str, str]:
    ...
    # (x-oms-app) so broker-side per-client burn tracking shows `roboms`
    # instead of an anonymous gateway client.
    env["OMS_APP_NAME"] = "roboms"
