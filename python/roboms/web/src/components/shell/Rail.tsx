...
// Inline nav glyphs — roboms has no icon library.
    ...
    <aside class="rmp-rail">
      ...
      <div class="rmp-rail-brand">
        ...
        <span class="rmp-rail-wordmark">
          <span class="rmp-rail-name">roboms</span>
      ...
      <nav class="rmp-nav">
        {NAV.map((item) => (
          <button
            ...
            title={item.locked ? "Triage — locked (set ROBOMS_REPLAY_TOKEN to enable)" : item.label}
