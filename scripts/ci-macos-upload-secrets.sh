...
# terminal transcript.
#
# Prepare a directory (default ~/oms-signing) containing:
...
#   OMS_REPO=owner/repo scripts/ci-macos-upload-secrets.sh ~/oms-signing
...
DIR="${DIR:-${OMS_SIGNING_DIR:-$HOME/oms-signing}}"
REPO="${OMS_REPO:-pickpocket/oh-my-soup}"
